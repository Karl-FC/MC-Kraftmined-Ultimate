...
public class ProbabilitiesShardExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(KraftmineModItems.SHARD_POSSIBILITIES.get(), new OptionalDispenseItemBehavior() {
