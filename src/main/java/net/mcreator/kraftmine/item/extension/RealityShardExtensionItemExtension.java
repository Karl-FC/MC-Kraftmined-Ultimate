...
public class RealityShardExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(KraftmineModItems.REALITY_SHARD.get(), new OptionalDispenseItemBehavior() {
