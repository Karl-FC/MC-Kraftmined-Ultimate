...
public class PositioningShardExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(KraftmineModItems.SHARD_POSITIONING.get(), new OptionalDispenseItemBehavior() {
