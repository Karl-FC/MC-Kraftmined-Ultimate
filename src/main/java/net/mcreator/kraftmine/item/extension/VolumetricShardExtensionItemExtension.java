...
public class VolumetricShardExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(KraftmineModItems.SHARD_VOLUMETRIC.get(), new OptionalDispenseItemBehavior() {
