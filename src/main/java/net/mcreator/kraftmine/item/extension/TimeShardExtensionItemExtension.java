...
public class TimeShardExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(KraftmineModItems.SHARD_TIME.get(), new OptionalDispenseItemBehavior() {
