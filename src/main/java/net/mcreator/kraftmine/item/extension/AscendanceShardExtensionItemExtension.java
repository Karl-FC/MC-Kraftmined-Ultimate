...
public class AscendanceShardExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(KraftmineModItems.ASCENDANCE_SHARD.get(), new OptionalDispenseItemBehavior() {
