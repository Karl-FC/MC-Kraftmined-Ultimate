...
public class OmnipotenceShardExtensionItemExtension {
	@SubscribeEvent
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> DispenserBlock.registerBehavior(KraftmineModItems.OMNIPOTENCE_SHARD.get(), new OptionalDispenseItemBehavior() {
