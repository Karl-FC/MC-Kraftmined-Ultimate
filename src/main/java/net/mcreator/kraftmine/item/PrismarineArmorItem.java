...
public abstract class PrismarineArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), () -> Ingredient.of(new ItemStack(Items.PRISMARINE_CRYSTALS)), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("kraftmine:prismarine"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("kraftmine:prismarine_armor"), armorMaterial);
