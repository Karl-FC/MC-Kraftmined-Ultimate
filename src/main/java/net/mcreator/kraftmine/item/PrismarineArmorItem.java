...
public abstract class PrismarineArmorItem extends ArmorItem {
	public PrismarineArmorItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends PrismarineArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "kraftmine:textures/models/armor/prismarine_layer_1.png";
		}
	}
	...
	public static class Leggings extends PrismarineArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "kraftmine:textures/models/armor/prismarine_layer_2.png";
		}
	}
