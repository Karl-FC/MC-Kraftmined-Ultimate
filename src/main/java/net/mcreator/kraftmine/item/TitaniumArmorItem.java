...
public abstract class TitaniumArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_iron")), () -> Ingredient.of(new ItemStack(KraftmineModItems.TITANIUM_INGOT.get())),
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("kraftmine:titanium"))), 4f, 0.4f);
			registerHelper.register(ResourceLocation.parse("kraftmine:titanium_armor"), armorMaterial);
