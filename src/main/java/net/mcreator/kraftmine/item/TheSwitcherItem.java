...
public class TheSwitcherItem extends Item {
	public TheSwitcherItem() {
	...
	public void onUseTick(Level world, LivingEntity entity, ItemStack itemstack, int count) {
		if (!world.isClientSide() && entity instanceof ServerPlayer player) {
			...
			if (player.getAbilities().instabuild || stack != ItemStack.EMPTY) {
				TheSwitcherProjectileEntity projectile = TheSwitcherProjectileEntity.shoot(world, entity, world.getRandom());
				itemstack.hurtAndBreak(1, entity, LivingEntity.getSlotForHand(entity.getUsedItemHand()));
	...
	private ItemStack findAmmo(Player player) {
		return new ItemStack(TheSwitcherProjectileEntity.PROJECTILE_ITEM.getItem());
	}
}
