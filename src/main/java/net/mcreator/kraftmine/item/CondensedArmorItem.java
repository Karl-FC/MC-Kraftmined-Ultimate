...
public abstract class CondensedArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 4, BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), () -> Ingredient.of(new ItemStack(KraftmineModBlocks.CLOUD_BLOCK_RAIN.get())), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("kraftmine:condensed"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("kraftmine:condensed_armor"), armorMaterial);
			ARMOR_MATERIAL = BuiltInRegistries.ARMOR_MATERIAL.wrapAsHolder(armorMaterial);
		});
	}

	public CondensedArmorItem(ArmorItem.Type type, Item.Properties properties) {
