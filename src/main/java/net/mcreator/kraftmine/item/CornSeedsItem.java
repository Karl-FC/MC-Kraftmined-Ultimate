...
public class CornSeedsItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		CornSeedsRightclickedOnBlockProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getPlayer());
