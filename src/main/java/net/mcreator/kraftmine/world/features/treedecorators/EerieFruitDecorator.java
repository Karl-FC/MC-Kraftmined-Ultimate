...
public class EerieFruitDecorator extends CocoaDecorator {
	public static MapCodec<EerieFruitDecorator> CODEC = MapCodec.unit(EerieFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("kraftmine:eerie_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}
