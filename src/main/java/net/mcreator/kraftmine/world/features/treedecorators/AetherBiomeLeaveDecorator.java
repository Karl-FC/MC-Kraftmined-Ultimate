...
public class AetherBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final AetherBiomeLeaveDecorator INSTANCE = new AetherBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("aether_biome_tree_leave_decorator", tdt);
	}

	public AetherBiomeLeaveDecorator() {
		super(0.25f);
	}
