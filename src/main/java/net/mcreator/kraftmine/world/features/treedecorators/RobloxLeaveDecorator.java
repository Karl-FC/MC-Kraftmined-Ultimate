...
public class RobloxLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<RobloxLeaveDecorator> CODEC = MapCodec.unit(RobloxLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("kraftmine:roblox_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public RobloxLeaveDecorator() {
		super(0.25f);
	}
