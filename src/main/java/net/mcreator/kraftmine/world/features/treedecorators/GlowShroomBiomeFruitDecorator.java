...
public class GlowShroomBiomeFruitDecorator extends CocoaDecorator {
	public static MapCodec<GlowShroomBiomeFruitDecorator> CODEC = MapCodec.unit(GlowShroomBiomeFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("kraftmine:glow_shroom_biome_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}
