...
public class PalmsmallFeature extends Feature<NoneFeatureConfiguration> {
	public static PalmsmallFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new PalmsmallFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("kraftmine:palmsmall", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("kraftmine:palmsmall", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public PalmsmallFeature() {
		super(NoneFeatureConfiguration.CODEC);
		base_blocks = List.of(Blocks.GRASS_BLOCK, Blocks.DIRT, Blocks.SAND, Blocks.GRAVEL);
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("kraftmine", "palm_small"));
		if (template == null)
			return false;
