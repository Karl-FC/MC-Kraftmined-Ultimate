...
public class TitaniumOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("kraftmine:titanium_ore", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(Blocks.STONE.defaultBlockState()), KraftmineModBlocks.TITANIUM_ORE.get().defaultBlockState())), 3));
		PLACED_FEATURE = PlacementUtils.register("kraftmine:titanium_ore", CONFIGURED_FEATURE,
