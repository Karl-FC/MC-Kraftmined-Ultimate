...
public class GlowShroomBiomeTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<GlowShroomBiomeTrunkDecorator> CODEC = MapCodec.unit(GlowShroomBiomeTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("kraftmine:glow_shroom_biome_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
