...
public class BackroomLevel0LeaveDecorator extends LeaveVineDecorator {
	public static final BackroomLevel0LeaveDecorator INSTANCE = new BackroomLevel0LeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("backroom_level_0_tree_leave_decorator", tdt);
	}
