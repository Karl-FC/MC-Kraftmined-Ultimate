...
public class BackroomLevel0LeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<BackroomLevel0LeaveDecorator> CODEC = MapCodec.unit(BackroomLevel0LeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("kraftmine:backroom_level_0_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public BackroomLevel0LeaveDecorator() {
		super(0.25f);
	}
