...
public class RobloxFruitDecorator extends CocoaDecorator {
	public static MapCodec<RobloxFruitDecorator> CODEC = MapCodec.unit(RobloxFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("kraftmine:roblox_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}
