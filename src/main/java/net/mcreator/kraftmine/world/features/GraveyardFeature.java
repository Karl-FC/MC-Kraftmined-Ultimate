...
public class GraveyardFeature extends Feature<NoneFeatureConfiguration> {
	public static GraveyardFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new GraveyardFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("kraftmine:graveyard", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("kraftmine:graveyard", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("kraftmine", "graveyard"));
		if (template == null)
			return false;
