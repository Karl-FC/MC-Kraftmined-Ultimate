...
public class SakuraLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<SakuraLeaveDecorator> CODEC = MapCodec.unit(SakuraLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("kraftmine:sakura_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public SakuraLeaveDecorator() {
		super(0.25f);
	}
