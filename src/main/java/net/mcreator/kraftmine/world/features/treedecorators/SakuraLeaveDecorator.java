...
public class SakuraLeaveDecorator extends LeaveVineDecorator {
	public static final SakuraLeaveDecorator INSTANCE = new SakuraLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("sakura_tree_leave_decorator", tdt);
	}
