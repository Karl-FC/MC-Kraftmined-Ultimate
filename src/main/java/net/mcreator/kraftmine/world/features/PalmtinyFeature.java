...
public class PalmtinyFeature extends Feature<NoneFeatureConfiguration> {
	public static PalmtinyFeature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new PalmtinyFeature();
		CONFIGURED_FEATURE = FeatureUtils.register("kraftmine:palmtiny", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("kraftmine:palmtiny", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("kraftmine", "palm_tiny"));
		if (template == null)
			return false;
