...
public class TungstenOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("kraftmine:tungsten_ore", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(Blocks.STONE.defaultBlockState()), KraftmineModBlocks.TUNGSTEN_ORE.get().defaultBlockState())), 4));
		PLACED_FEATURE = PlacementUtils.register("kraftmine:tungsten_ore", CONFIGURED_FEATURE,
