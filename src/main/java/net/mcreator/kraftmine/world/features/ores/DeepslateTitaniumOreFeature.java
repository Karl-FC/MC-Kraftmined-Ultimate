...
public class DeepslateTitaniumOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("kraftmine:deepslate_titanium_ore", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(Blocks.STONE.defaultBlockState()), KraftmineModBlocks.DEEPSLATE_TITANIUM_ORE.get().defaultBlockState())), 3));
		PLACED_FEATURE = PlacementUtils.register("kraftmine:deepslate_titanium_ore", CONFIGURED_FEATURE,
