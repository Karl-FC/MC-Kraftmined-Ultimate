...
public class SakuraFruitDecorator extends CocoaDecorator {
	public static MapCodec<SakuraFruitDecorator> CODEC = MapCodec.unit(SakuraFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("kraftmine:sakura_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}
