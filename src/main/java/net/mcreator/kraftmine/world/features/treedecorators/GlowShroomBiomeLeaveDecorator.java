...
public class GlowShroomBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final GlowShroomBiomeLeaveDecorator INSTANCE = new GlowShroomBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		ForgeRegistries.TREE_DECORATOR_TYPES.register("glow_shroom_biome_tree_leave_decorator", tdt);
	}
