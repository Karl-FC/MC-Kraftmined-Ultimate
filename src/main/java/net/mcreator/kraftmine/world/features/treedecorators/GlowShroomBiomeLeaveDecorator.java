...
public class GlowShroomBiomeLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<GlowShroomBiomeLeaveDecorator> CODEC = MapCodec.unit(GlowShroomBiomeLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("kraftmine:glow_shroom_biome_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public GlowShroomBiomeLeaveDecorator() {
		super(0.25f);
	}
