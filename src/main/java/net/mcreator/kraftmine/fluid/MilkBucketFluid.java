...
public abstract class MilkBucketFluid extends ForgeFlowingFluid {
	public static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(() -> KraftmineModFluidTypes.MILK_BUCKET_TYPE.get(), () -> KraftmineModFluids.MILK_BUCKET.get(), () -> KraftmineModFluids.FLOWING_MILK_BUCKET.get())
