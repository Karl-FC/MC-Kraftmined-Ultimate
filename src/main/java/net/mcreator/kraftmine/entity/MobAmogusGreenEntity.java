...
public class MobAmogusGreenEntity extends Monster {
	public MobAmogusGreenEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(KraftmineModEntities.MOB_AMOGUS_GREEN.get(), world);
	}

	public MobAmogusGreenEntity(EntityType<MobAmogusGreenEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(5, new AvoidEntityGoal<>(this, IronGolem.class, (float) 6, 1, 0.5));
	...
	public static void init() {
		SpawnPlacements.register(KraftmineModEntities.MOB_AMOGUS_GREEN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> (world.getBlockState(pos.below()).getMaterial() == Material.GRASS && world.getRawBrightness(pos, 0) > 8));
		DungeonHooks.addDungeonMob(KraftmineModEntities.MOB_AMOGUS_GREEN.get(), 180);
	}
