...
import net.mcreator.kraftmine.procedures.HerobrineOnInitialEntitySpawnProcedure;
import net.mcreator.kraftmine.procedures.HerobrineOnEntityTickUpdateProcedure;
import net.mcreator.kraftmine.procedures.HerobrineEntityIsHurtProcedure;
import net.mcreator.kraftmine.procedures.HerobrineEntityDiesProcedure;
...
public class HerobrineEntity extends Monster {
	...
	public HerobrineEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(KraftmineModEntities.HEROBRINE.get(), world);
	}
	...
	public boolean hurt(DamageSource source, float amount) {
		HerobrineEntityIsHurtProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), this);
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.FOLLOW_RANGE, 120.00);
		return builder;
	}
}
