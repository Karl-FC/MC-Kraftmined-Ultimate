...
public class AmongamiteEntity extends Monster {
	public AmongamiteEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(KraftmineModEntities.AMONGAMITE.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(KraftmineModEntities.AMONGAMITE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
