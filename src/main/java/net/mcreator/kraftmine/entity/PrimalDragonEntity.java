...
public class PrimalDragonEntity extends Monster {
	public PrimalDragonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(KraftmineModEntities.PRIMAL_DRAGON.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(KraftmineModEntities.PRIMAL_DRAGON.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
