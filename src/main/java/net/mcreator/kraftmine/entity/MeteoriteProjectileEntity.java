...
public class MeteoriteProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public static MeteoriteProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		MeteoriteProjectileEntity entityarrow = new MeteoriteProjectileEntity(KraftmineModEntities.METEORITE_PROJECTILE.get(), entity, world, null);
		...
		world.playSound(null, entity.getX(), entity.getY(), entity.getZ(), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("entity.firework_rocket.large_blast")), SoundSource.PLAYERS, 1, 1f / (random.nextFloat() * 0.5f + 1) + (power / 2));
		return entityarrow;
	}

	public static MeteoriteProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		MeteoriteProjectileEntity entityarrow = new MeteoriteProjectileEntity(KraftmineModEntities.METEORITE_PROJECTILE.get(), entity, entity.level(), null);
		...
		entity.level().playSound(null, entity.getX(), entity.getY(), entity.getZ(), BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("entity.firework_rocket.large_blast")), SoundSource.PLAYERS, 1,
