...
public class BuffaloEntity extends Animal {
	public BuffaloEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(KraftmineModEntities.BUFFALO.get(), world);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		BuffaloEntity retval = KraftmineModEntities.BUFFALO.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(KraftmineModEntities.BUFFALO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
