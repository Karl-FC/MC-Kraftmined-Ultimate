...
public class ShrooMooEntity extends Cow {
	public ShrooMooEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(KraftmineModEntities.SHROO_MOO.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(KraftmineModEntities.SHROO_MOO.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
