...
public class ShrooMooEntity extends Cow {
	public ShrooMooEntity(EntityType<ShrooMooEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(KraftmineModEntities.SHROO_MOO.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
