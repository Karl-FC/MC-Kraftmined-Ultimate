...
public class MobAmogusGreyEntity extends Monster {
	public MobAmogusGreyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(KraftmineModEntities.MOB_AMOGUS_GREY.get(), world);
	}

	public MobAmogusGreyEntity(EntityType<MobAmogusGreyEntity> type, Level world) {
		super(type, world);
		xpReward = 10;
		setNoAi(false);
	}
	...
	public static void init() {
		SpawnPlacements.register(KraftmineModEntities.MOB_AMOGUS_GREY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> (world.getBlockState(pos.below()).getMaterial() == Material.GRASS && world.getRawBrightness(pos, 0) > 8));
		DungeonHooks.addDungeonMob(KraftmineModEntities.MOB_AMOGUS_GREY.get(), 180);
	}
