...
public class BeetzookaEntity extends AbstractArrow implements ItemSupplier {
	public BeetzookaEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(KraftmineModEntities.BEETZOOKA.get(), world);
	}

	public BeetzookaEntity(EntityType<? extends BeetzookaEntity> type, Level world) {
		super(type, world);
	}

	public BeetzookaEntity(EntityType<? extends BeetzookaEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public BeetzookaEntity(EntityType<? extends BeetzookaEntity> type, LivingEntity entity, Level world) {
	...
	public static BeetzookaEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		BeetzookaEntity entityarrow = new BeetzookaEntity(KraftmineModEntities.BEETZOOKA.get(), entity, world);
	...
	public static BeetzookaEntity shoot(LivingEntity entity, LivingEntity target) {
		BeetzookaEntity entityarrow = new BeetzookaEntity(KraftmineModEntities.BEETZOOKA.get(), entity, entity.level);
