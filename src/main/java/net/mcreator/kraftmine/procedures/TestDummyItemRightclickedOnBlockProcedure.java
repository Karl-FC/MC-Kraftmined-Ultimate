...
public class TestDummyItemRightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate, Entity entity, ItemStack itemstack) {
		if (entity == null)
			return;
		double Sus_Color = 0;
		if (blockstate.getMaterial() == net.minecraft.world.level.material.Material.PLANT) {
			world.setBlock(new BlockPos(x, y, z), Blocks.AIR.defaultBlockState(), 3);
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = new TestDummyEntity(KraftmineModEntities.TEST_DUMMY.get(), _level);
