...
public class MugRightclickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == KraftmineModItems.MUG.get() && entity.level()
			...
			if ((world
				...
				if (!(entity instanceof Player _plr ? _plr.getAbilities().instabuild : false)) {
					if (entity instanceof LivingEntity _entity) {
						ItemStack _setstack = new ItemStack(KraftmineModItems.MUG.get()).copy();
				...
				if (entity instanceof Player _player) {
					ItemStack _setstack = new ItemStack(KraftmineModItems.WATER_CUP_MUG.get()).copy();
