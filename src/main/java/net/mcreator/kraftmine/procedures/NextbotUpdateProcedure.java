		...
		if (!(entity.getPersistentData().getDouble("BotVariant") == 4 || entity.getPersistentData().getDouble("BotVariant") == 9)) {
			if ((entity.getDirection()) == Direction.NORTH || (entity.getDirection()) == Direction.SOUTH) {
				if (!world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3((x + 2), y, z), 2, 2, 2), e -> true).isEmpty()) {
					if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3((x + 2), y, z), 2, 2, 2), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
							return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
						}
					}.compareDistOf((x + 2), y, z)).findFirst().orElse(null)) instanceof LivingEntity _entity)
						_entity.hurt(new DamageSource("nextbot").bypassArmor(), 10);
					...
					if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3((x + 2), (y + 3), z), 2, 2, 2), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
							return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
						}
					}.compareDistOf((x + 2), (y + 3), z)).findFirst().orElse(null)) instanceof LivingEntity _entity)
						_entity.hurt(new DamageSource("nextbot").bypassArmor(), 10);
				} else if (!world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3((x - 2), (y + 3), z), 2, 2, 2), e -> true).isEmpty()) {
					if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3((x - 2), (y + 3), z), 2, 2, 2), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
					...
					if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, (y + 3), z), 2, 2, 2), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
							return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
						}
					}.compareDistOf(x, (y + 3), z)).findFirst().orElse(null)) instanceof LivingEntity _entity)
						_entity.hurt(new DamageSource("nextbot").bypassArmor(), 10);
				}
				...
				if (!world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, (z + 2)), 2, 2, 2), e -> true).isEmpty()) {
					if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, (z + 2)), 2, 2, 2), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
							return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
						}
					}.compareDistOf(x, y, (z + 2))).findFirst().orElse(null)) instanceof LivingEntity _entity)
						_entity.hurt(new DamageSource("nextbot").bypassArmor(), 10);
					...
					if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, (y + 3), (z + 2)), 2, 2, 2), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
							return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
						}
					}.compareDistOf(x, (y + 3), (z + 2))).findFirst().orElse(null)) instanceof LivingEntity _entity)
						_entity.hurt(new DamageSource("nextbot").bypassArmor(), 10);
				} else if (!world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, (y + 3), (z - 2)), 2, 2, 2), e -> true).isEmpty()) {
					if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, (y + 3), (z - 2)), 2, 2, 2), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
			...
			if ((entity.getDirection()) == Direction.NORTH || (entity.getDirection()) == Direction.SOUTH) {
				...
				if (!world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, (z + 1)), 2, 2, 2), e -> true).isEmpty()) {
					...
					}.compareDistOf(x, y, (z + 1))).findFirst().orElse(null)) instanceof LivingEntity _entity)
						_entity.hurt(new DamageSource("nextbot").bypassArmor(), 10);
					...
					if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, (y + 3), (z + 1)), 2, 2, 2), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
							return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
						}
					}.compareDistOf(x, (y + 3), (z + 1))).findFirst().orElse(null)) instanceof LivingEntity _entity)
						_entity.hurt(new DamageSource("nextbot").bypassArmor(), 10);
				} else if (!world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, (y + 3), (z - 1)), 2, 2, 2), e -> true).isEmpty()) {
					if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, (y + 3), (z - 1)), 2, 2, 2), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
			...
			if ((entity.getDirection()) == Direction.NORTH || (entity.getDirection()) == Direction.SOUTH) {
				if (!world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3((x + 4), y, z), 2, 2, 2), e -> true).isEmpty()) {
					if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3((x + 4), y, z), 2, 2, 2), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
							return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
						}
					}.compareDistOf((x + 4), y, z)).findFirst().orElse(null)) instanceof LivingEntity _entity)
						_entity.hurt(new DamageSource("nextbot").bypassArmor(), 10);
					...
					if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3((x + 4), (y + 4), z), 2, 2, 2), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
							return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
						}
					}.compareDistOf((x + 4), (y + 4), z)).findFirst().orElse(null)) instanceof LivingEntity _entity)
						_entity.hurt(new DamageSource("nextbot").bypassArmor(), 10);
				} else if (!world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3((x - 4), (y + 4), z), 2, 2, 2), e -> true).isEmpty()) {
					if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3((x - 4), (y + 4), z), 2, 2, 2), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
					...
					if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, (y + 4), z), 2, 2, 2), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
							return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
						}
					}.compareDistOf(x, (y + 4), z)).findFirst().orElse(null)) instanceof LivingEntity _entity)
						_entity.hurt(new DamageSource("nextbot").bypassArmor(), 10);
				}
			} else if ((entity.getDirection()) == Direction.EAST || (entity.getDirection()) == Direction.WEST) {
				if (!world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, (z + 4)), 2, 2, 2), e -> true).isEmpty()) {
					if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, y, (z + 4)), 2, 2, 2), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
							return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
						}
					}.compareDistOf(x, y, (z + 4))).findFirst().orElse(null)) instanceof LivingEntity _entity)
						_entity.hurt(new DamageSource("nextbot").bypassArmor(), 10);
					...
					if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, (y + 4), (z + 4)), 2, 2, 2), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
							return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
						}
					}.compareDistOf(x, (y + 4), (z + 4))).findFirst().orElse(null)) instanceof LivingEntity _entity)
						_entity.hurt(new DamageSource("nextbot").bypassArmor(), 10);
				} else if (!world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, (y + 4), (z - 4)), 2, 2, 2), e -> true).isEmpty()) {
					if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, (y + 4), (z - 4)), 2, 2, 2), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
					...
					if (((Entity) world.getEntitiesOfClass(Player.class, AABB.ofSize(new Vec3(x, (y + 4), z), 3, 3, 3), e -> true).stream().sorted(new Object() {
						Comparator<Entity> compareDistOf(double _x, double _y, double _z) {
							return Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(_x, _y, _z));
						}
					}.compareDistOf(x, (y + 4), z)).findFirst().orElse(null)) instanceof LivingEntity _entity)
