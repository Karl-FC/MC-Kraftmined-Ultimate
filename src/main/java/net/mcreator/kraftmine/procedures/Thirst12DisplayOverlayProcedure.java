...
public class Thirst12DisplayOverlayProcedure {
	public static boolean execute(LevelAccessor world, Entity entity) {
		...
		if (new Object() {
			public boolean checkGamemode(Entity _ent) {
				...
				&& (entity.getCapability(KraftmineModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new KraftmineModVariables.PlayerVariables())).Thirstlevel > 22) {
			return true;
		}
		return false;
	}
