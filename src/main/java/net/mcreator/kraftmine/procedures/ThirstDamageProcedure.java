	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		...
		if (new Object() {
			public boolean checkGamemode(Entity _ent) {
				...
				&& !(entity instanceof LivingEntity _livEnt3 && _livEnt3.hasEffect(KraftmineModMobEffects.HYDRATED))) {
			if (entity.getData(KraftmineModVariables.PLAYER_VARIABLES).Thirstlevel <= 0) {
