...
public class ThirstAttackProcedureProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		...
		}.checkGamemode(entity) && !(world.getDifficulty() == Difficulty.PEACEFUL) && world.getLevelData().getGameRules().getBoolean(KraftmineModGameRules.HYDRATION) == true && entity.getData(KraftmineModVariables.PLAYER_VARIABLES).Thirstlevel > 0) {
			{
