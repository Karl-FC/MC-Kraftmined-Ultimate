...
public class InfinitePotionHydrationRightclickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (EnchantmentHelper.getItemEnchantmentLevel(KraftmineModEnchantments.REPLENISHMENT.get(), Thepotion) != 0) {
			...
			if (entity instanceof LivingEntity _entity)
				_entity.addEffect(new MobEffectInstance(KraftmineModMobEffects.HYDRATED.get(), (int) (20 * (30 + MoreCD * 30)), 1));
			...
			if (entity instanceof LivingEntity _entity)
				_entity.addEffect(new MobEffectInstance(KraftmineModMobEffects.HYDRATED.get(), (int) (20 * (20 + MoreHeal * 5)), (int) (MoreHeal + 1)));
		} else {
			if (entity instanceof Player _player)
				_player.getCooldowns().addCooldown(Thepotion.getItem(), 600);
			if (entity instanceof LivingEntity _entity)
				_entity.addEffect(new MobEffectInstance(KraftmineModMobEffects.HYDRATED.get(), 400, 1));
		}
		if (entity instanceof LivingEntity _entity)
