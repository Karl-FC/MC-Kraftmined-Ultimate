	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition base = partdefinition
				.addOrReplaceChild("base",
						CubeListBuilder.create().texOffs(0, 19).addBox(-15.0F, 0.0F, 1.0F, 14.0F, 10.0F, 14.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(8.0F, 24.0F, 8.0F, 3.1416F, 0.0F, 0.0F));

		PartDefinition lid = partdefinition
				.addOrReplaceChild("lid",
						CubeListBuilder.create().texOffs(0, 0).addBox(-15.0F, 0.0F, 0.0F, 14.0F, 5.0F, 14.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(8.0F, 15.0F, 7.0F, 3.1416F, 0.0F, 0.0F));

		PartDefinition knob = partdefinition
				.addOrReplaceChild("knob",
						CubeListBuilder.create().texOffs(0, 0).addBox(-9.0F, -1.0F, 15.0F, 2.0F, 4.0F, 1.0F,
								new CubeDeformation(0.0F)),
