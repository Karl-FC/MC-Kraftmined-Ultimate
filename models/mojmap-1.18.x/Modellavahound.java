...
public class Modellavahound<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "lavahound"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_rotation = head.addOrReplaceChild("head_rotation",
				CubeListBuilder.create().texOffs(0, 19)
						...
						.addBox(6.0F, -7.0F, -11.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(10, 13)
						.addBox(-8.0F, -7.0F, -11.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(10, 13)
						.addBox(-8.0F, -5.0F, -6.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(1, 13)
						.addBox(6.0F, -5.0F, -6.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(10, 13)
						.addBox(-8.0F, -9.0F, -17.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(1, 13)
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 12).addBox(
				-3.0F, -3.0F, -9.0F, 7.0F, 5.0F, 18.0F, new CubeDeformation(4.0F)), PartPose.offset(0.0F, 7.0F, 4.5F));

		PartDefinition left_gills = body.addOrReplaceChild("left_gills",
				CubeListBuilder.create().texOffs(0, 40)
						.addBox(-3.0F, -5.0F, 0.0F, 3.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 40)
						.addBox(-3.0F, -5.0F, 9.0F, 3.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 40)
						.addBox(-3.0F, -5.0F, 18.0F, 3.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-7.0F, 1.0F, -10.5F));

		PartDefinition top_gills = body.addOrReplaceChild("top_gills", CubeListBuilder.create().texOffs(3, 37).addBox(
				-4.0F, -3.0F, 0.0F, 8.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -7.0F, -10.5F));

		PartDefinition right_gills = body.addOrReplaceChild("right_gills",
				CubeListBuilder.create().texOffs(11, 40)
						.addBox(0.0F, -5.0F, 0.0F, 3.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(11, 40)
						.addBox(0.0F, -5.0F, 9.0F, 3.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(11, 40)
						.addBox(0.0F, -5.0F, 18.0F, 3.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 1.0F, -10.5F));

		PartDefinition front_left_leg = partdefinition.addOrReplaceChild("front_left_leg", CubeListBuilder.create()
				.texOffs(25, 37).addBox(-3.0F, 0.0F, -2.75F, 6.0F, 14.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(4.0F, 10.0F, -4.75F));

		PartDefinition front_right_leg = partdefinition.addOrReplaceChild("front_right_leg", CubeListBuilder.create()
				.texOffs(32, 41).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 14.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-4.0F, 10.0F, -4.5F));

		PartDefinition back_left_leg = partdefinition.addOrReplaceChild("back_left_leg", CubeListBuilder.create()
				.texOffs(0, 45).addBox(-2.5F, 0.0F, -2.5F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offset(4.5F, 13.0F, 14.0F));
