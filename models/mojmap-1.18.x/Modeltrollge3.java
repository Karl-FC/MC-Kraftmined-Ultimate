...
public class Modeltrollge3<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "trollge3"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cloud = partdefinition.addOrReplaceChild("cloud", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-61.235F, 94.4072F, -32.0F, 128.0F, 64.0F, 64.0F, new CubeDeformation(28.0F)).texOffs(0, 0)
				.addBox(-61.235F, -154.5928F, -32.0F, 128.0F, 64.0F, 64.0F, new CubeDeformation(28.0F)),
		...
		PartDefinition cube_r1 = cloud.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 137)
						.addBox(-116.0F, 9.0F, -53.0F, 29.0F, 17.0F, 64.0F, new CubeDeformation(28.0F)).texOffs(0, 137)
						.addBox(-116.0F, -282.0F, -53.0F, 29.0F, 17.0F, 64.0F, new CubeDeformation(28.0F)),
		...
		PartDefinition cube_r2 = cloud.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 137)
						.addBox(112.0F, -40.0F, -53.0F, 29.0F, 17.0F, 64.0F, new CubeDeformation(28.0F)).texOffs(0, 137)
						.addBox(-24.0F, -320.0F, -53.0F, 29.0F, 17.0F, 64.0F, new CubeDeformation(28.0F)),
		...
		PartDefinition cube_r3 = cloud.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-231.0F, 101.0F, -53.0F, 128.0F, 64.0F, 64.0F, new CubeDeformation(28.0F)).texOffs(0, 0)
						.addBox(-231.0F, -169.0F, -53.0F, 128.0F, 64.0F, 64.0F, new CubeDeformation(28.0F)),
				PartPose.offsetAndRotation(0.765F, 180.4072F, 21.0F, 0.0F, 0.0F, 1.5708F));

		PartDefinition bigcloud = partdefinition.addOrReplaceChild("bigcloud", CubeListBuilder.create().texOffs(0, 512)
				.addBox(-128.0F, -120.0F, -114.0F, 256.0F, 256.0F, 256.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition face = partdefinition.addOrReplaceChild("face", CubeListBuilder.create().texOffs(704, 0)
				.addBox(-48.0F, -66.0F, 46.0F, 128.0F, 128.0F, 32.0F, new CubeDeformation(0.0F)),
