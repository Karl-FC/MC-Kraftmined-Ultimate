...
public abstract class WoodArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 1, BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), () -> Ingredient.of(), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("km_kombat:wood"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("km_kombat:wood_armor"), armorMaterial);
