...
public abstract class TitaniumArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 12, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_netherite")), () -> Ingredient.of(new ItemStack(KmKombatModItems.TUNGSTEN_INGOT.get())),
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("km_kombat:titanium"))), 0f, 0.1f);
			registerHelper.register(ResourceLocation.parse("km_kombat:titanium_armor"), armorMaterial);
