...
import net.mcreator.kraftmined.kombat.procedures.RedstoneArmorReddedProcedure;
...
public abstract class RedstoneArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, BuiltInRegistries.SOUND_EVENT.wrapAsHolder(SoundEvents.EMPTY), () -> Ingredient.of(), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("km_kombat:redstone"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("km_kombat:redstone_armor"), armorMaterial);
	...
	public static class Helmet extends RedstoneArmorItem {
		...
		public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
			...
			if (entity instanceof Player player && Iterables.contains(player.getArmorSlots(), itemstack)) {
				RedstoneArmorReddedProcedure.execute(entity);
			}
		}
	}
