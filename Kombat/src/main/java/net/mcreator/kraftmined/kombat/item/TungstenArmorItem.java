...
import net.mcreator.kraftmined.kombat.procedures.ArmorWeightProcedure;
...
public abstract class TungstenArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 6, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_netherite")), () -> Ingredient.of(new ItemStack(KmKombatModItems.TUNGSTEN_INGOT.get())),
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("km_kombat:tungsten"))), 2f, 0.1f);
			registerHelper.register(ResourceLocation.parse("km_kombat:tungsten_armor"), armorMaterial);
	...
	public static class Helmet extends TungstenArmorItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.literal("Enchantibility: Low"));
