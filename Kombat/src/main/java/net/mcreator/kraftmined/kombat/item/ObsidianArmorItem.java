...
public abstract class ObsidianArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 30, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_gold")), () -> Ingredient.of(new ItemStack(KmKombatModItems.OBSIDIAN_SCRAP.get())),
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("km_kombat:obsidian"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("km_kombat:obsidian_armor"), armorMaterial);
