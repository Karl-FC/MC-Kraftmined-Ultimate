...
public abstract class CactusArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_generic")), () -> Ingredient.of(new ItemStack(Blocks.CACTUS)), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("km_kombat:cactus"))), 0f,
					0f);
			registerHelper.register(ResourceLocation.parse("km_kombat:cactus_armor"), armorMaterial);
