...
public abstract class NickelArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 1, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_turtle")), () -> Ingredient.of(), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("km_kombat:nickel"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("km_kombat:nickel_armor"), armorMaterial);
