...
public class TntArmorhitProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getItem() == KraftminedModItems.TNT_ARMOR_HELMET.get()) {
		...
		if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.CHEST) : ItemStack.EMPTY).getItem() == KraftminedModItems.TNT_ARMOR_CHESTPLATE.get()) {
		...
		if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.LEGS) : ItemStack.EMPTY).getItem() == KraftminedModItems.TNT_ARMOR_LEGGINGS.get()) {
		...
		if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getItem() == KraftminedModItems.TNT_ARMOR_BOOTS.get()) {
			if (Math.random() < (2 / 4) * 0.15) {
				{
					Entity _entity = entity;
					if (_entity instanceof Player _player) {
