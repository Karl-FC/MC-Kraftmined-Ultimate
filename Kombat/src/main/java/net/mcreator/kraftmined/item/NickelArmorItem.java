...
public abstract class NickelArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 1, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_turtle")), () -> Ingredient.of(), List.of(new ArmorMaterial.Layer(ResourceLocation.parse("kraftmined:nickel"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("kraftmined:nickel_armor"), armorMaterial);
	...
	public static class Helmet extends NickelArmorItem {
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.literal("Protection: Medium"));
			list.add(Component.literal("Durability: High"));
			list.add(Component.literal("Special: Pulls nearby items"));
		}
	}
