...
public abstract class TungstenArmorItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 6, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("item.armor.equip_netherite")), () -> Ingredient.of(new ItemStack(KraftminedModItems.TUNGSTEN_INGOT.get())),
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("kraftmined:tungsten"))), 2f, 0.1f);
			registerHelper.register(ResourceLocation.parse("kraftmined:tungsten_armor"), armorMaterial);
