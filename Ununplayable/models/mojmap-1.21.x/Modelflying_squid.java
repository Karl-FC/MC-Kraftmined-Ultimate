...
public class Modelflying_squid<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "flying_squid"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition tentacle2 = body
				.addOrReplaceChild("tentacle2",
						CubeListBuilder.create().texOffs(48, 0).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 18.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(3.5F, 7.0F, 3.5F, 0.0F, 0.7854F, 0.0F));

		PartDefinition tentacle3 = body.addOrReplaceChild("tentacle3", CubeListBuilder.create().texOffs(48, 0).addBox(
				-1.0F, 0.0F, -1.0F, 2.0F, 18.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 7.0F, 5.0F));
		...
		PartDefinition tentacle5 = body.addOrReplaceChild("tentacle5",
				CubeListBuilder.create().texOffs(48, 0).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 18.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, 7.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

		PartDefinition tentacle6 = body.addOrReplaceChild("tentacle6",
				CubeListBuilder.create().texOffs(48, 0).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 18.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.5F, 7.0F, -3.5F, 0.0F, -2.3562F, 0.0F));

		PartDefinition tentacle7 = body.addOrReplaceChild("tentacle7",
				CubeListBuilder.create().texOffs(48, 0).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 18.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 7.0F, -5.0F, 0.0F, -3.1416F, 0.0F));

		PartDefinition tentacle8 = body
				.addOrReplaceChild("tentacle8",
						CubeListBuilder.create().texOffs(48, 0).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 18.0F, 2.0F,
								new CubeDeformation(0.0F)),
