...
public class ModelGoose<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bill = head.addOrReplaceChild("bill", CubeListBuilder.create().texOffs(8, 0).addBox(-1.0F,
				-14.0F, -5.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 4.0F, 1.0F));

		PartDefinition chin = head.addOrReplaceChild("chin", CubeListBuilder.create(),
				PartPose.offset(0.0F, 4.0F, 1.0F));

		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 14)
						.addBox(-3.0F, -6.0F, -4.0F, 6.0F, 9.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(40, 0)
						.addBox(-2.0F, 3.0F, -1.0F, 4.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 16.0F, 0.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition left_wing = partdefinition.addOrReplaceChild("left_wing", CubeListBuilder.create().texOffs(24, 8)
				.addBox(0.0F, -1.0F, -4.0F, 1.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_wing = partdefinition.addOrReplaceChild("right_wing", CubeListBuilder.create()
				.texOffs(24, 8).addBox(-1.0F, -1.0F, -4.0F, 1.0F, 7.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-3.0F, 13.0F, 0.0F));
		...
		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(26, 0)
				.addBox(-5.0F, 0.0F, -3.0F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
