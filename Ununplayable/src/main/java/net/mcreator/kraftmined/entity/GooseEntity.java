...
package net.mcreator.kraftmined.entity;
...
import net.mcreator.kraftmined.procedures.GooseOnInitialEntitySpawnProcedure;
...
public class GooseEntity extends PathfinderMob {
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(KraftminedModEntities.GOOSE.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
