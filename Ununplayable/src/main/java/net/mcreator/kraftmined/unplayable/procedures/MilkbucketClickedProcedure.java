...
public class MilkbucketClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.BUCKET && entity.level()
			...
			if ((world
					...
					.createLegacyBlock()).getBlock() == KmUnplayableModBlocks.MILK.get()) {
